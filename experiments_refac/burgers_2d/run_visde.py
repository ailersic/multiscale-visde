from experiments_refac.burgers_2d.train_visde import main as train_visde_main
from experiments_refac.burgers_2d.postproc_visde import main as postproc_visde_main
from experiments_refac.burgers_2d.plot_kernel import main as plot_kernel_main
