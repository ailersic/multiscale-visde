from experiments_refac.kdv_1d.train_visde import main as train_visde_main
from experiments_refac.kdv_1d.postproc_visde import main as postproc_visde_main
from experiments_refac.kdv_1d.plot_kernel import main as plot_kernel_main
