...
def main(config: CaseConfig = DEFAULT_CONFIG) -> None:
    ...
    for j, j_t in enumerate(tsamples):
        ...
        ax.imshow(x_true[j_t, 0], cmap=cmap, vmin=-1, vmax=1)
        plt.axis("off")
        fig.tight_layout()
        ...
        fig, ax = plt.subplots(figsize=(3, 3))
        ax.imshow(x_mean[0], cmap=cmap, vmin=-1, vmax=1)
        plt.axis("off")
        fig.tight_layout()
        ...
        fig, ax = plt.subplots(figsize=(3, 3))
        ax.imshow(np.abs(x_true[j_t, 0] - x_mean[0]), cmap="afmhot", vmin=0, vmax=0.5)
        plt.axis("off")
        fig.tight_layout()
        ...
        fig, ax = plt.subplots(figsize=(3, 3))
        ax.imshow(x_std[0], cmap="afmhot", vmin=0, vmax=0.5)
        plt.axis("off")
        fig.tight_layout()
