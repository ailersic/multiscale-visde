from experiments_refac.wave_1d.sindy_2step.train_psindy import main as train_psindy_main
from experiments_refac.wave_1d.sindy_2step.postproc_psindy import main as postproc_psindy_main
import pathlib
import sys
import time
import json
